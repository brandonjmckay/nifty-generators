= Div Generator Branch
My modification on the Nifty Generators gem. Currently changes the HAML scaffold templates to use divs marked up for Foundation by Zurb.
